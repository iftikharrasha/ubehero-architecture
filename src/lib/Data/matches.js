...
//1. participants = n;
//2. matches = n - 1; if p64 = m63
//3. rounds = log2(n); i.e p64 -> r6

//IF participants = 64
// participants should be a power of 2 each round (32) (2, 4, 8, 16, 32, 64)
// And the total match will be each round 1 + 2 + 4 + 8 + 16 + 32 = 63
// So total will be 6 rounds, base-2 logarithm of the total number of participants.

// function calculateMatchesAndRounds(participants) {
...
//   const { matches, rounds } = calculateMatchesAndRounds(participants);
